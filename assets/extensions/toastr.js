...
function alert_toastr(type,msg){
    if (type=='success') {
        toastr.success(msg , ' ',{positionClass: 'toast-top-center',containerId: 'toast-top-center',"showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 1500});
    }
    else if(type=='info'){
        toastr.info(msg , ' ',{positionClass: 'toast-top-center',containerId: 'toast-top-center',"showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 1500});
    }
    else if(type=='warning'){
        toastr.warning(msg , ' ',{positionClass: 'toast-top-center',containerId: 'toast-top-center',"showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 1500});
    }
    else if(type=='error'){
        toastr.error(msg , ' ',{positionClass: 'toast-top-center',containerId: 'toast-top-center',"showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 1500});
    }
    else {
        toastr.error(msg , ' ',{positionClass: 'toast-top-center',containerId: 'toast-top-center',"showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 1500});
    }
