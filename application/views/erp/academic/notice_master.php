      ...
      <div class="col-12">
         ...
         <div class="row justify-content-center">
             <div class="col-md-12">
                ...
                <button class="float-right btn btn-primary  ml-1   btn-sm " href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add <?=$title;?>" data-url="<?=$new_url?>" >Add Notice</button>
                </h3>
