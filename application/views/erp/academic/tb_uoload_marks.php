<div class="card-body table-responsive p-0 pb-2">
                ...
                <?php $i=$page;foreach($rows as $r){
                  ...
                  <tr>
                    ...
                    <td><?=$r->sub_name;?></td>
                     <td>
                    <a  class="btn btn-sm btn-success" href="<?=base_url('student-marks-upload/marks_upload/'.$r->id);?>">
                    Upload Here..
                       </a>
                    </td>
                    <td> 
                    <a  class="btn btn-sm btn-warning " href="<?=base_url();?>student-marks-upload/view_marks/<?=$r->id;?>">View Marks</a>
                   </td>
                  </tr>
                  <?php }?>
                  </tbody>
