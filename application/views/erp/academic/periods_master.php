      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                ...
                <div class="col-md-6">
                <select name="section"  class="form-control col-12" onchange="fetch_section_period(this.value)">
                    <option >--Select Section--</option>
                    <?php foreach($section as $c){?>
                    <option value="<?=$c->id;?>" <?php if(isset($_POST['section']) && $_POST['section']==$c->id){echo "selected";} ;?>><?=$c->section_name;?></option>
                    <?php }?>
                </select>
              </div>
                    <div class="col-md-6">
                ...
                <h3 class="card-title float-right mt-1">
                <button class=" btn btn-primary btn-sm" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Periods" data-url="<?=$new_url?>" >Add Period</button>
                </h3>
              </div>
              <!-- /.card-header -->
...
<script>
      function fetch_section_period(section)
   {
        $.ajax({
            url: "<?php echo base_url('academic-section-wise-period-master/tb'); ?>",
            method: "POST",
            data: {
              section:section,
            },
