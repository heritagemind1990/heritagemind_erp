...
<?php }else{?>
    ...
    <?php foreach($count as $c){?>
        ...
        <div class="col-6">
            <div class="form-group">
                <label class="control-label">Bank Name:</label>
                <input type="text" name="bankname" class="form-control" value="<?=$c->bank;?>">
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                <label class="control-label">IFSC Code</label>
              <input type="text" class="form-control" name="ifsccode" value="<?=$c->ifsc;?>">
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="card">
            <img src="<?php echo IMGS_URL.$c->self_pic ;?>" alt="" height="100px">
        </div>
        </div>
        <div class="col-3">
        <span>Aadhaar File</span>   
        <div class="card">
            <img src="<?php echo IMGS_URL.$c->adharfile ;?>" alt="" height="100px">
        </div>
        </div>
        <div class="col-3">
        <span>Pan File</span>   
        <div class="card">
            <img src="<?php echo IMGS_URL.$c->panfile ;?>" alt="" height="100px">
        </div>
        </div>
        <div class="col-3">
