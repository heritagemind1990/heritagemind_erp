          ...
          <div class="modal-content">
            ...
            <div class="row">
              ...
              <div class="col-6 form-group">
               ...
               <input type="text" class="form-control" value="<?=$t->bank;?>" readonly>
              </div>
              <div class="col-6 form-group">
              ...
              <div class="col-6 form-group">
               ...
               <input type="text" class="form-control" value="<?=$t->ifsc;?>" readonly>
              </div>
              <hr style="border: 2px solid black;width:100%">
        <div class="col-3">
         <span>Self Photo</span> &nbsp;&nbsp;  
         <?php if($t->self_pic  !=''){?>
           <a href="<?php echo IMGS_URL.$t->self_pic ;?>" download="<?php echo IMGS_URL.$t->self_pic ;?>"><i class="fa-solid fa-download" download></i></a>
             <?php }else{?>
             <span><i  class="fa-solid fa-download" download></i></span>
           <?php }?>
        <div class="card">
            <img src="<?php echo IMGS_URL.$t->self_pic ;?>" alt="" height="100px">
        </div>
        </div>
        <div class="col-3">
        <span>Aadhaar File</span> &nbsp;&nbsp;  
         <?php if($t->adharfile  !=''){?>
           <a href="<?php echo IMGS_URL.$t->adharfile ;?>" download="<?php echo IMGS_URL.$t->adharfile ;?>"><i class="fa-solid fa-download" download></i></a>
             <?php }else{?>
             <span><i  class="fa-solid fa-download" download></i></span>
           <?php }?>   
        <div class="card">
            <img src="<?php echo IMGS_URL.$t->adharfile ;?>" alt="" height="100px">
        </div>
        </div>
        <div class="col-3">
        <span>Pan File</span>   &nbsp;&nbsp;  
         <?php if($t->panfile  !=''){?>
           <a href="<?php echo IMGS_URL.$t->panfile ;?>" download="<?php echo IMGS_URL.$t->panfile ;?>"><i class="fa-solid fa-download" download></i></a>
             <?php }else{?>
             <span><i  class="fa-solid fa-download" download></i></span>
           <?php }?>   
        <div class="card">
            <img src="<?php echo IMGS_URL.$t->panfile ;?>" alt="" height="100px">
        </div>
        </div>
        <div class="col-3">
