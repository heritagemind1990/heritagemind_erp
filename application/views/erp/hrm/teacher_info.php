      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                <a href="<?=base_url();?>hrm-data" class="btn btn-danger btn-sm"><i class="fas fa-backward"></i>   Back</a>
                </h3>
                ...
                <button class="btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add <?=$title;?>" data-url="<?=$new_url?>" >Add Teacher</button>
                </h3>
