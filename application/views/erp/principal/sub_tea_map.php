      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                ...
                <button class="btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal-xl" data-whatever="Add <?=$title;?>" data-url="<?=$new_url?>" >Add Mapping</button>
                </h3>
                <div class="card-title float-left col-md-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="form-group mb-0">
                           <label for="">Select Section To See Subject  Teacher  Mapping</label>
