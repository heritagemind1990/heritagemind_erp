    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-1">
              <div class="card">
              <img src="<?php echo IMGS_URL.$student->self_img ;?>" alt="" height="100px">
              </div>
            </div>
             <div class="col-md-11">
            <div class="col-md-4">
                ...
                <table class="table table-hover text-nowrap  table-bordered" id="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$row->type;?></td>
                        <td> 
                        <button class="btn btn-sm btn-<?php if($row->principal_check=='0'){echo "warning";}else{echo "success";};?>"><?php if($row->principal_check=='0'){echo "Pending";}else{echo "Approved";};?></button>
