        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>section-head-date">Section Head</a></li>
      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                <a href="<?=base_url();?>section-head-upload-hw" class="btn btn-danger btn-sm"><i class="fas fa-backward"></i>   Back</a>
                </h3>
