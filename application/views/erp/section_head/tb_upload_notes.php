<div class="card-body table-responsive p-0 pb-2">
                ...
                <?php $i=$page;foreach($rows as $r){
                  ...
                  <tr>
                    ...
                    <td><?=$r->sub_name;?></td>
                     ...
                     <td>
                      <?php
                       $count = $this->erp_model->Counter('tb_notes', array('sst_id'=>$r->id,'sec_id'=>$r->section_id,'sub_id'=>$r->sub_id,'tea_id'=>$r->tea_id,'date'=>date('Y-m-d'),'is_deleted'=>'NOT_DELETED'));
                       ;
                       if($count==0){
                       ?>
    ...
    <script>
      function notes()
      {
        ...
        alert_toastr("error","Today already uploaded this subject notes");
      }
    </script>