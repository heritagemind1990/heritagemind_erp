        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>student-route-map">Transport</a></li>
      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                ...
                <button class="btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Student" data-url="<?=$new_url?>" >Add Student</button>
                </h3>
                ...
                <select name="route_id"  class="form-control col-12" onchange="fetch_cat_student(this.value)">
                    <option >--Select Route--</option>
                    <?php foreach($route as $c){?>
                    <option value="<?=$c->id;?>" <?php if(isset($_POST['route_id']) && $_POST['route_id']==$c->id){echo "selected";} ;?>><?=$c->start_route.' '.$c->end_route;?></option>
                    <?php }?>
                </select>
              </div>
                    <div class="col-md-6 col-xl-6 pt-1">
...
loadtb();
     function fetch_route_student(route_id)
   {
        $.ajax({
            url: "<?php echo base_url('student-route-map/tb'); ?>",
            method: "POST",
            data: {
              route_id:route_id,
            },
