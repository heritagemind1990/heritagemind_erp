        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>class-teacher-date">Class Teacher</a></li>
      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                <a href="<?=base_url();?>class-teacher-upload-hw" class="btn btn-danger btn-sm"><i class="fas fa-backward"></i>   Back</a>
                </h3>
