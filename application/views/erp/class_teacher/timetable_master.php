    ...
    <section class="content">
      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-left ml-2 col-4">
                <select name="section" id="section" class="form-control" onchange="fetch_section(this.value)">
              ...
              <h3 class="card-title text-center col-4 text-danger font-weight-bolder">
                Please select section then view your time table
              </h3>
              </div>
              <!-- /.card-header -->
...
<script>
       function fetch_section(section)
   {
        $.ajax({
            url: "<?php echo base_url('view-class-teacher-time-table/tb'); ?>",
            method: "POST",
            data: {
              section:section,
            },
