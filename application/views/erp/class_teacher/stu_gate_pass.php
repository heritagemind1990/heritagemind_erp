...
<script>
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?php echo base_url('class-teacher-student-gate-pass/search_data'); ?>",
                type: "POST",
                dataType: "json",
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, record) {
                        var row = "<tr><td>" + record.stu_id + "</td><td>" + record.enrollment + "</td><td>" + record.fname + record.lname + "</td><td>" + record.section_name + "</td><td>" + record.father + "</td><td>" + record.mother + "</td><td>" + record.father_no + "</td><td><a href='<?=base_url("class-teacher-student-gate-pass/createpass/");?>"+ record.id +"' class='btn btn-sm btn-primary'>Create GatePass</a></td></tr>";
                        table.append(row);
                    });
                }
            });
