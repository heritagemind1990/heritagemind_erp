      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                <a href="<?=base_url();?>library-data" class="btn btn-danger btn-sm mt-1"><i class="fas fa-backward"></i>   Back</a>
                </h3>
                ...
                <button class=" btn btn-primary btn-sm" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Book Category" data-url="<?=$new_url?>" >Add Book Category</button>
                </h3>
              </div>
              <!-- /.card-header -->
