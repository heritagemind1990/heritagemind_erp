          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="col-md-6">
                ...
                <select name="category"  class="form-control col-12" onchange="fetch_cat_student(this.value)">
                    <option >--Select Category--</option>
                    <?php foreach($category as $c){?>
                    <option value="<?=$c->id;?>" <?php if(isset($_POST['category']) && $_POST['category']==$c->id){echo "selected";} ;?>><?=$c->name;?></option>
                    <?php }?>
                </select>
              </div>
...
loadtb();
  ...
  <script>
       function fetch_cat_student(cat_id)
   {
        $.ajax({
            url: "<?php echo base_url('category-wise-student/tb'); ?>",
            method: "POST",
            data: {
              category:cat_id,
            },
