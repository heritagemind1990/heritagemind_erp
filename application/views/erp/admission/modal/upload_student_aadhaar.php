...
$(document).ready(function() {
    $(".validate-form").validate({
        ...
        messages: {
            photo: {
                required : "Please Select Aadhaar",
            }
        }
    }); 
});
    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="form-group">
                <label class="control-label">Select Aadhaar <sup>*</sup> :</label>
...
<div class="modal-footer">
    ...
    <button id="btnsubmit" type="submit" class="btn btn-danger btn-sm waves-light" ><i id="loader" class=""></i>Add Aadhaar</button>
</div>
