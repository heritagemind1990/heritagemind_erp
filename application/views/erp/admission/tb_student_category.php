<div class="card-body table-responsive p-0 pb-2">
                <table class="table table-hover text-nowrap  table-bordered">
                  ...
                  echo $added_date = gmdate("d/m/Y", $unix_date); ?></td>
                    <td> <button class="btn btn-primary btn-sm" onclick="return display_details(<?php echo $s->id; ?>, '<?php echo base_url('view-register-student/view-more') ?>')">View More</button></td>
                  </tr>
                  <?php };?>
                  </tbody>
                </table>
              </div>        <div class="row pb-3 pl-2 pr-2 ">
