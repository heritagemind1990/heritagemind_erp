                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $i=1;foreach($classdata as $data){?>
                    <tr>
                        ...
                        <td>
                        <button class="btn btn-primary btn-sm" onclick="return display_details(<?php echo $data->id; ?>, '<?php echo base_url('view-section-not-allot-student/view-more') ?>')">View More</button><br>
                        <a href="<?=base_url('section-allot-student/sec_allot/'.$data->id);?>" class="btn btn-success btn-sm mt-1" >Section Allot</a>
                        </td>
                    </tr>
                    <?php $i++;}?>
                  </tbody>
