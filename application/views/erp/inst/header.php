...
<label for="" class="success"></label>
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light myheader fixed-top" style="height:57px">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>inst-dashboard" class="nav-link">Home</a>
      </li>
    </ul>
