...
<script>
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?php echo base_url('student-fee-collection-report/search_data'); ?>",
                type: "POST",
                dataType: "json",
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, record) {
                        var row = "<tr><td>" + record.stu_id + "</td><td>" + record.enrollment + "</td><td>" + record.fname + record.lname + "</td><td>" + record.section_name + "</td><td>" + record.father + "</td><td>" + record.mother + "</td><td>" + record.father_no + "</td><td><a href='<?=base_url("student-fee-collection-report/view_fee/");?>"+ record.id +"' class='btn btn-sm btn-primary'>View Fee</a></td></tr>";
                        table.append(row);
                    });
                }
            });
