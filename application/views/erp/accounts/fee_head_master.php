      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right mt-1 ml-2">
                ...
                <button class=" btn btn-primary btn-sm" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Fee Head" data-url="<?=$new_url?>" >Add Fee Head</button>
                </h3>
              </div>
              <!-- /.card-header -->
